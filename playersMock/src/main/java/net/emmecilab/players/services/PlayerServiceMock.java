...
public class PlayerServiceMock implements PlayerService {
	...
	private List<Player> players = new ArrayList<>(
			Arrays.asList(new Player(Long.valueOf(1), "Francesco", "Totti", "Roma", "midfielder"),
					new Player(Long.valueOf(2), "Gonzalo", "Higuain", "Juventus", "forward"),
					new Player(Long.valueOf(3), "Mauro", "Icardi", "Inter", "forward")));
